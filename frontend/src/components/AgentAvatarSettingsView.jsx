          ...
          <div className="flex flex-wrap items-center gap-2">
            {PRESET_COLORS.map((col) => {
              ...
              return (
                <button
                  ...
                  className={`relative w-7.5 h-7.5 rounded-xl shadow-xs transition-all cursor-pointer flex items-center justify-center ${
                    isSelected
            ...
            <div className="relative">
              ...
              <button
                ...
                className="h-7.5 px-2.5 rounded-xl border border-dashed border-slate-300 hover:border-slate-500 bg-white text-[11px] font-bold text-slate-700 flex items-center gap-1.5 shadow-2xs hover:bg-slate-50 transition-all cursor-pointer"
