 ...
 * Authentic close-up vector portrait styled after The Delegation avatar design or BoxHead chibi,
...
export default function AgentCloseUpAvatar({
  ...
  const isBoxHead = agent?.avatar_type === 'boxhead'
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: isBoxHead ? '#38bdf8' : color }}
      />
      ...
      >
        ...
        >
          {isBoxHead ? (
            /* --- BoxHead Chibi Avatar Portrait --- */
            <g>
              {/* Torso */}
              <path
                d="M12 42C14 39 18 38 24 38C30 38 34 39 36 42C36 44 35 46 35 46H13C13 46 12 44 12 42Z"
                fill="#446889"
              />
              {/* Rounded Box Head */}
              <rect x="7" y="6" width="34" height="32" rx="7.5" fill="#94beea" />
              {/* Subtle bottom shadow on head */}
              <path
                d="M7 32C7 35.5 10 38 14.5 38H33.5C38 38 41 35.5 41 32H7Z"
                fill="black"
                fillOpacity="0.08"
              />
              {/* Determined Eyebrows */}
              <path
                d="M12 18.5C14.5 19 18.5 20.5 21 23"
                stroke="#25475e"
                strokeWidth="2.6"
                strokeLinecap="round"
              />
              <path
                d="M36 18.5C33.5 19 29.5 20.5 27 23"
                stroke="#25475e"
                strokeWidth="2.6"
                strokeLinecap="round"
              />
              {/* Left Eye: White socket + Dark iris + Catchlight */}
              <circle cx="16.5" cy="25" r="4.6" fill="white" />
              <circle cx="16.5" cy="25" r="3.2" fill="#1b2a38" />
              <circle cx="18" cy="23.5" r="1.3" fill="white" />

              {/* Right Eye: White socket + Dark iris + Catchlight */}
              <circle cx="31.5" cy="25" r="4.6" fill="white" />
              <circle cx="31.5" cy="25" r="3.2" fill="#1b2a38" />
              <circle cx="33" cy="23.5" r="1.3" fill="white" />

              {/* Cute Inverted-V Mouth ^ */}
              <path
                d="M21.5 31.5L24 29L26.5 31.5"
                stroke="#1b2a38"
                strokeWidth="2"
                strokeLinecap="round"
            ...
            /* --- Classic The Delegation Chibi Avatar --- */
            <g>
